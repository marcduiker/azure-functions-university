...
|-|-|-|-|-
|0|Prerequisites|[.NET Core](dotnet/prerequisites-dotnet.md) , [TypeScript](typescript/prerequisites-ts.md)|[Oct 28th](https://youtu.be/5k35dlBAXxA)|Marc & Gwyneth (.NET Core) , Christian & Marc (TypeScript)
|1|HTTP Trigger|[.NET Core](dotnet/http/http-lesson-dotnet.md) , [TypeScript](typescript/http-ts.md)|[Oct 28th](https://youtu.be/5k35dlBAXxA)|Marc & Gwyneth (.NET Core) , Christian & Marc (TypeScript)
