...
- For more info about the Blob Trigger and bindings have a look at the official [Azure Functons Blob Storage](https://docs.microsoft.com/en-us/azure/azure-functions/functions-bindings-storage-blob) documentation.
